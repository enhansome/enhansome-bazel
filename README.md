...
Have something to contribute or discuss? [Open a pull request](https://github.com/jin/awesome-bazel/pulls) ⭐ 1,239 | 🐛 13 | 📅 2024-11-13 or [create an issue](https://github.com/jin/awesome-bazel/issues) ⭐ 1,239 | 🐛 13 | 📅 2024-11-13.
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,276 | 🐛 1,318 | 🌐 TypeScript | 📅 2026-08-16 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 516 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-15 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
* [bazelbuild/bazel-watcher](https://github.com/bazelbuild/bazel-watcher) ⭐ 511 | 🐛 20 | 🌐 Go | 📅 2026-07-23 - Automatically run Bazel commands when source files change
* [bazelbuild/sandboxfs](https://github.com/bazelbuild/sandboxfs) ⚠️ Archived - A virtual file system for sandboxing
* [nadirizr/dazel](https://github.com/nadirizr/dazel) ⭐ 179 | 🐛 24 | 🌐 Python | 📅 2025-06-30 - Run Bazel inside a Docker container via a seamless proxy
* [spotify/bazel-tools](https://github.com/spotify/bazel-tools) ⚠️ Archived - Spotify's production tools for dealing with very large Bazel-managed repositories.
* [graknlabs/bazel-distribution](https://github.com/graknlabs/bazel-distribution) ⭐ 165 | 🐛 37 | 🌐 Starlark | 📅 2026-08-13 - Assemble and deploy software distributions to common platforms, e.g. APT, Brew, GitHub, Maven, NPM, PIP, RPM, etc.
* [atlassian/bazel-tools](https://github.com/atlassian/bazel-tools) ⚠️ Archived - Atlassian's reusable bits for Bazel
* [bazel-super-formatter](https://github.com/aspect-build/bazel-super-formatter) ⚠️ Archived - Hermetic aggregation formatter to format code in most languages
* [bzl-io/bzl](https://github.com/bzl-io/bzl) ⭐ 50 | 🐛 19 | 📅 2023-04-12 - a wrapper around the bazel build tool to extend its functionality
* [Asana/bazeltsc](https://github.com/Asana/bazeltsc) ⚠️ Archived - TypeScript compiler that knows how to run as a Bazel persistent worker
...
* [philwo/bazelisk](https://github.com/philwo/bazelisk) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2025-08-23 - A user-friendly launcher for Bazel
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 370 | 🐛 65 | 🌐 Starlark | 📅 2026-08-15 - LLVM toolchain for bazel
* [bazelbuilds/bazel-toolchains](https://github.com/bazelbuild/bazel-toolchains) ⭐ 203 | 🐛 49 | 🌐 Go | 📅 2026-07-30 -  Bazel toolchain configurations to enable Google Cloud Remote Build Execution via Docker containers
* [hexdae/bazel-arm-none-eabi](https://github.com/hexdae/bazel-arm-none-eabi) ⭐ 140 | 🐛 14 | 🌐 Starlark | 📅 2026-07-30 - embedded ARM toolchain
* [f0rmiga/gcc-toolchain](https://github.com/f0rmiga/gcc-toolchain) ⭐ 137 | 🐛 17 | 🌐 Starlark | 📅 2026-08-11 - A fully-hermetic Bazel GCC toolchain for Linux
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,068 | 🐛 96 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 70 | 🌐 Starlark | 📅 2026-08-10 - More common useful functions for writing custom build rules with Starlark
* [Stardoc](https://github.com/bazelbuild/stardoc) ⭐ 118 | 🐛 60 | 🌐 Java | 📅 2026-06-23 - Starlark documentation generator
* [Bazel Common Libraries](https://github.com/google/bazel-common) ⭐ 90 | 🐛 19 | 🌐 Starlark | 📅 2026-08-05 - **Java-specific** Common functionality for Google's open-source libraries that are built with Bazel.
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,746 | 🐛 76 | 🌐 Go | 📅 2026-07-10 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 781 | 🐛 261 | 🌐 Go | 📅 2026-08-15 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 769 | 🐛 173 | 🌐 Java | 📅 2026-07-17 - Self-hosted remote caching and execution service written in Java
* [bazel-remote](https://github.com/buchgr/bazel-remote) ⭐ 764 | 🐛 81 | 🌐 Go | 📅 2026-07-29 - A simple remote cache for Bazel that supports HTTP and gRPC, with optional proxy backends for S3/GCS/HTTP.
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,411 | 🐛 455 | 🌐 Go | 📅 2026-08-14 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,411 | 🐛 455 | 🌐 Go | 📅 2026-08-14
...
* [Jadep: Java Automated Dependencies](https://github.com/bazelbuild/tools_jvm_autodeps) ⭐ 53 | 🐛 14 | 🌐 Go | 📅 2019-01-30 - Generate BUILD files automatically for an existing Java project with class dependency analysis.
* [BUILD File Generator](https://github.com/bazelbuild/BUILD_file_generator) ⚠️ Archived - Similar tool for existing Java projects.
* [Pazel](https://github.com/tuomasr/pazel) ⭐ 39 | 🐛 10 | 🌐 Python | 📅 2023-06-06 - Generate Bazel BUILD files for Python
* [create-bazel-workspace](https://github.com/jin/create-bazel-workspace) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2018-07-29 - Generate a new multi-language Bazel workspace with minimal configuration
* [llvmbzlgen](https://github.com/kythe/llvmbzlgen) ⚠️ Archived - Tools for generating Bazel BUILD targets from LLVM CMakeLists
* [bazel-to-msbuild](https://github.com/sammi/bazel-to-msbuild) ⭐ 13 | 🐛 1 | 🌐 C++ | 📅 2022-01-19 - Generate Visual Studio solution and projects from bazel workspace, command line tool build by Java.
...
* [hedronvision/bazel-compile-commands-extractor](https://github.com/hedronvision/bazel-compile-commands-extractor) ⭐ 913 | 🐛 100 | 🌐 Python | 📅 2025-08-11 enables autocomplete, smart navigation, quick fixes, and more in a wide variety of extensible editors, including VSCode, Vim, Emacs, Atom, and Sublime. It lets language servers, like clangd, ccls, and other types of tooling, draw upon Bazel’s understanding of how `cc` and `objc` code will be compiled, including how it configures cross-compilation for other platforms.
* [georgewfraser/java-language-server](https://github.com/georgewfraser/java-language-server) ⭐ 809 | 🐛 116 | 🌐 Java | 📅 2026-08-11 - Java Language Server (LSP) with support for Bazel-built projects
* [rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) ⭐ 625 | 🐛 150 | 🌐 Swift | 📅 2026-08-11 - Generates Xcode projects for your workspace that builds with Bazel
...
* [PyCharm](https://github.com/tomhanetz/bazel-for-human-beings) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2019-02-15
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,419 | 🐛 442 | 🌐 Java | 📅 2026-08-15
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 294 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-13
  * [stackb/bazel-stack-vscode](https://github.com/stackb/bazel-stack-vscode) ⭐ 70 | 🐛 21 | 🌐 TypeScript | 📅 2023-08-07.  Includes syntax highlighting / flag completion for bazelrc files.  Hover support for inline builtin-function and bazel rule documentation.  [VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=StackBuild.bazel-stack-vscode).
  * [VSCode Bazel Java extension](https://github.com/salesforce/bazel-ls-vscode) ⚠️ Archived - Proof-of-concept (POC) of a Bazel Java development extension for VS Code
  * [stackb/bazel-stack-vscode-cc](https://github.com/stackb/bazel-stack-vscode-cc) ⭐ 33 | 🐛 6 | 🌐 Starlark | 📅 2022-12-29.  Supports generation of clang compilation databases.  [VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=StackBuild.bazel-stack-vscode-cc).

### BUILD file tools

[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,187 | 🐛 116 | 🌐 Go | 📅 2026-07-16 contains:

* Buildifier - Prettifier for `BUILD` and `.bzl` files
* Buildozer - Manipulate `BUILD` file contents from the command line
* unused\_deps - Find unneeded dependencies in BUILD files

### Migration

* [johnynek/bazel-deps](https://github.com/johnynek/bazel-deps) ⭐ 254 | 🐛 107 | 🌐 Scala | 📅 2025-12-15 - Generate bazel dependencies transitively for Maven artifacts, with scala support.
* [wix-incubator/exodus](https://github.com/wix-incubator/exodus) ⭐ 229 | 🐛 17 | 🌐 Scala | 📅 2023-09-18 - Easily migrate your JVM code from Maven to Bazel
* [stripe/sbt-bazel](https://github.com/stripe/sbt-bazel) ⚠️ Archived - Easily convert SBT projects to Bazel workspaces
* [bazelbuild/migration-tooling](https://github.com/bazelbuild/migration-tooling) ⚠️ Archived - Migrate an existing Maven project to Bazel.
* [rules\_maven](https://github.com/pubref/rules_maven) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2019-04-13 - Rules to define Maven dependencies
* [bazelize-maven-plugin](https://github.com/OrhanKupusoglu/bazelize-maven-plugin) ⭐ 17 | 🐛 3 | 🌐 Java | 📅 2026-03-28 - Maven plugin for migration from Maven to Bazel
* [bazelbuild/gmaven\_rules](https://github.com/bazelbuild/gmaven_rules) ⚠️ Archived - Transitive WORKSPACE rules for Google's Maven repository

### <a name="misc-tooling"></a>Misc

* [salesforce/bazel-maven-proxy](https://github.com/salesforce/bazel-maven-proxy/) ⭐ 24 | 🐛 2 | 🌐 Java | 📅 2026-06-02 - A local proxy to access Maven resources behind secure repositories or from the local repo

## Resources

### Designs

* [bazelbuild/proposals](https://github.com/bazelbuild/proposals) ⭐ 136 | 🐛 10 | 📅 2026-07-24 - Index of all design documents and proposals for Bazel.
...
* [Bazel Mystery](https://github.com/salesforce/bazel-mystery) ⭐ 69 | 🐛 1 | 🌐 Starlark | 📅 2026-07-23 - Gamified workspace to learn about Bazel.
* [Bazel Lesson 1](https://github.com/sayrer/bazel-lesson-1) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2019-05-25 and [Bazel Lesson 2](https://github.com/sayrer/bazel-lesson-2) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2019-10-10 - Gradually build a multi-language Bazel project.
* [Real-world Bazel](https://github.com/cgbystrom/real-world-bazel) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2018-12-29 - BUILD files collected from public GitHub projects for reference and learning purposes.
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,048 | 🐛 2,858 | 🌐 C++ | 📅 2026-08-16: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,004 | 🐛 17 | 🌐 Starlark | 📅 2026-08-15 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,080 | 🐛 229 | 🌐 C++ | 📅 2026-08-15 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [squzy/squzy](https://github.com/squzy/squzy) ⭐ 478 | 🐛 15 | 🌐 Go | 📅 2026-07-21 - is a high-performance open-source monitoring system written in Golang with Bazel. Using Bazel for testing, building and dockerize.
* [alexeagle/angular-bazel-example](https://github.com/alexeagle/angular-bazel-example) ⚠️ Archived: Building an Angular application with Bazel
  * ABC: Angular Buildtools Convergence <https://g.co/ng/abc>
* [bazelment/trunk](https://github.com/bazelment/trunk) ⭐ 242 | 🐛 14 | 🌐 Python | 📅 2026-08-15: A collection of C++/Java OSS with BUILD files. e.g. grpc, guava, netty.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 847 | 🐛 103 | 🌐 Swift | 📅 2026-08-15.
