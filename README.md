...
Have something to contribute or discuss? [Open a pull request](https://github.com/jin/awesome-bazel/pulls) ⭐ 1,241 | 🐛 13 | 📅 2024-11-13 or [create an issue](https://github.com/jin/awesome-bazel/issues) ⭐ 1,241 | 🐛 13 | 📅 2024-11-13.
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,548 | 🐛 1,434 | 🌐 TypeScript | 📅 2026-09-21 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 524 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
* [bazelbuild/bazel-watcher](https://github.com/bazelbuild/bazel-watcher) ⭐ 513 | 🐛 18 | 🌐 Go | 📅 2026-08-26 - Automatically run Bazel commands when source files change
...
* [gerrit/bazlets](https://github.com/GerritCodeReview/bazlets) ⭐ 14 | 🐛 1 | 🌐 Starlark | 📅 2026-09-20 - Gerrit's re-usable building blocks for Bazel build tool
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 371 | 🐛 65 | 🌐 Starlark | 📅 2026-09-17 - LLVM toolchain for bazel
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,091 | 🐛 98 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 80 | 🌐 Starlark | 📅 2026-09-20 - More common useful functions for writing custom build rules with Starlark
...
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-09-20 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,771 | 🐛 79 | 🌐 Go | 📅 2026-09-12 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 787 | 🐛 199 | 🌐 Go | 📅 2026-09-21 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
...
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 773 | 🐛 170 | 🌐 Java | 📅 2026-09-18 - Self-hosted remote caching and execution service written in Java
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,417 | 🐛 469 | 🌐 Go | 📅 2026-09-18 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,417 | 🐛 469 | 🌐 Go | 📅 2026-09-18
...
* [rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) ⭐ 626 | 🐛 147 | 🌐 Swift | 📅 2026-09-17 - Generates Xcode projects for your workspace that builds with Bazel
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,443 | 🐛 449 | 🌐 Java | 📅 2026-09-18
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 296 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-19
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,192 | 🐛 122 | 🌐 Go | 📅 2026-09-21 contains:
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 200,218 | 🐛 3,230 | 🌐 C++ | 📅 2026-09-21: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,087 | 🐛 14 | 🌐 Starlark | 📅 2026-09-20 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,136 | 🐛 241 | 🌐 C++ | 📅 2026-09-19 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 845 | 🐛 111 | 🌐 Swift | 📅 2026-09-19.
