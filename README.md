...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,249 | 🐛 1,311 | 🌐 TypeScript | 📅 2026-08-13 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 516 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-11 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
* [bazelbuild/bazel-watcher](https://github.com/bazelbuild/bazel-watcher) ⭐ 511 | 🐛 19 | 🌐 Go | 📅 2026-07-23 - Automatically run Bazel commands when source files change
...
* [graknlabs/bazel-distribution](https://github.com/graknlabs/bazel-distribution) ⭐ 165 | 🐛 37 | 🌐 Starlark | 📅 2026-07-30 - Assemble and deploy software distributions to common platforms, e.g. APT, Brew, GitHub, Maven, NPM, PIP, RPM, etc.
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 370 | 🐛 69 | 🌐 Starlark | 📅 2026-08-12 - LLVM toolchain for bazel
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,063 | 🐛 96 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 181 | 🐛 70 | 🌐 Starlark | 📅 2026-08-10 - More common useful functions for writing custom build rules with Starlark
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 779 | 🐛 252 | 🌐 Go | 📅 2026-08-13 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 768 | 🐛 172 | 🌐 Java | 📅 2026-07-17 - Self-hosted remote caching and execution service written in Java
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,411 | 🐛 454 | 🌐 Go | 📅 2026-08-11 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,411 | 🐛 454 | 🌐 Go | 📅 2026-08-11
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,416 | 🐛 442 | 🌐 Java | 📅 2026-08-12
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 294 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-10
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,185 | 🐛 116 | 🌐 Go | 📅 2026-07-16 contains:
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 196,986 | 🐛 2,828 | 🌐 C++ | 📅 2026-08-13: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 22,945 | 🐛 19 | 🌐 Starlark | 📅 2026-08-11 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,074 | 🐛 229 | 🌐 C++ | 📅 2026-08-13 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [bazelment/trunk](https://github.com/bazelment/trunk) ⭐ 242 | 🐛 14 | 🌐 Python | 📅 2022-08-15: A collection of C++/Java OSS with BUILD files. e.g. grpc, guava, netty.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 847 | 🐛 103 | 🌐 Swift | 📅 2026-08-12.
