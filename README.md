...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,503 | 🐛 1,521 | 🌐 TypeScript | 📅 2026-09-15 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 523 | 🐛 4 | 🌐 Rust | 📅 2026-09-14 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 371 | 🐛 66 | 🌐 Starlark | 📅 2026-09-15 - LLVM toolchain for bazel
...
* [f0rmiga/gcc-toolchain](https://github.com/f0rmiga/gcc-toolchain) ⭐ 138 | 🐛 18 | 🌐 Starlark | 📅 2026-08-11 - A fully-hermetic Bazel GCC toolchain for Linux
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,086 | 🐛 97 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 81 | 🌐 Starlark | 📅 2026-09-14 - More common useful functions for writing custom build rules with Starlark
* [Stardoc](https://github.com/bazelbuild/stardoc) ⭐ 118 | 🐛 60 | 🌐 Java | 📅 2026-06-23 - Starlark documentation generator
* [Bazel Common Libraries](https://github.com/google/bazel-common) ⭐ 91 | 🐛 19 | 🌐 Starlark | 📅 2026-09-08 - **Java-specific** Common functionality for Google's open-source libraries that are built with Bazel.
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,761 | 🐛 79 | 🌐 Go | 📅 2026-09-12 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 787 | 🐛 218 | 🌐 Go | 📅 2026-09-15 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
...
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 773 | 🐛 179 | 🌐 Java | 📅 2026-09-15 - Self-hosted remote caching and execution service written in Java
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,417 | 🐛 464 | 🌐 Go | 📅 2026-09-14 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,417 | 🐛 464 | 🌐 Go | 📅 2026-09-14
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,438 | 🐛 447 | 🌐 Java | 📅 2026-09-12
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 296 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-14
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,191 | 🐛 125 | 🌐 Go | 📅 2026-09-14 contains:
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 200,091 | 🐛 3,172 | 🌐 C++ | 📅 2026-09-15: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,074 | 🐛 14 | 🌐 Starlark | 📅 2026-09-14 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,136 | 🐛 239 | 🌐 C++ | 📅 2026-09-14 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 846 | 🐛 110 | 🌐 Swift | 📅 2026-09-15.
