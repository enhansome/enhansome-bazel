...
Have something to contribute or discuss? [Open a pull request](https://github.com/jin/awesome-bazel/pulls) ⭐ 1,242 | 🐛 13 | 📅 2024-11-13 or [create an issue](https://github.com/jin/awesome-bazel/issues) ⭐ 1,242 | 🐛 13 | 📅 2024-11-13.
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,577 | 🐛 1,438 | 🌐 TypeScript | 📅 2026-09-24 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 524 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
* [bazelbuild/bazel-watcher](https://github.com/bazelbuild/bazel-watcher) ⭐ 513 | 🐛 15 | 🌐 Go | 📅 2026-08-26 - Automatically run Bazel commands when source files change
...
* [graknlabs/bazel-distribution](https://github.com/graknlabs/bazel-distribution) ⭐ 165 | 🐛 37 | 🌐 Starlark | 📅 2026-09-01 - Assemble and deploy software distributions to common platforms, e.g. APT, Brew, GitHub, Maven, NPM, PIP, RPM, etc.
...
* [bzl-io/bzl](https://github.com/bzl-io/bzl) ⭐ 51 | 🐛 19 | 📅 2023-04-12 - a wrapper around the bazel build tool to extend its functionality
...
* [JetBrains/teamcity-bazel-plugin](https://github.com/JetBrains/teamcity-bazel-plugin) ⭐ 16 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-08 - TeamCity plugin for Bazel ([blogpost](https://blog.jetbrains.com/teamcity/2018/11/bazel-plugin-for-teamcity/))
* [gerrit/bazlets](https://github.com/GerritCodeReview/bazlets) ⭐ 14 | 🐛 1 | 🌐 Starlark | 📅 2026-09-21 - Gerrit's re-usable building blocks for Bazel build tool
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 372 | 🐛 64 | 🌐 Starlark | 📅 2026-09-24 - LLVM toolchain for bazel
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,093 | 🐛 98 | 🌐 Python | 📅 2026-02-06
* [Starlark in Go](https://github.com/google/skylark) ⚠️ Archived
* [Skylib](https://github.com/bazelbuild/bazel-skylib) ⭐ 445 | 🐛 141 | 🌐 Starlark | 📅 2026-09-01 - Common useful functions for writing custom build rules with Starlark
* [Starlark in Rust](https://github.com/google/starlark-rust) ⚠️ Archived
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 80 | 🌐 Starlark | 📅 2026-09-22 - More common useful functions for writing custom build rules with Starlark
* [Stardoc](https://github.com/bazelbuild/stardoc) ⭐ 118 | 🐛 60 | 🌐 Java | 📅 2026-06-23 - Starlark documentation generator
* [Bazel Common Libraries](https://github.com/google/bazel-common) ⭐ 91 | 🐛 19 | 🌐 Starlark | 📅 2026-09-18 - **Java-specific** Common functionality for Google's open-source libraries that are built with Bazel.
* [Starlet](https://github.com/1set/starlet) ⭐ 49 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,774 | 🐛 80 | 🌐 Go | 📅 2026-09-12 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 787 | 🐛 205 | 🌐 Go | 📅 2026-09-24 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
...
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 774 | 🐛 171 | 🌐 Java | 📅 2026-09-21 - Self-hosted remote caching and execution service written in Java
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,418 | 🐛 462 | 🌐 Go | 📅 2026-09-23 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,418 | 🐛 462 | 🌐 Go | 📅 2026-09-23
...
* [hedronvision/bazel-compile-commands-extractor](https://github.com/hedronvision/bazel-compile-commands-extractor) ⭐ 918 | 🐛 100 | 🌐 Python | 📅 2025-08-11 enables autocomplete, smart navigation, quick fixes, and more in a wide variety of extensible editors, including VSCode, Vim, Emacs, Atom, and Sublime. It lets language servers, like clangd, ccls, and other types of tooling, draw upon Bazel’s understanding of how `cc` and `objc` code will be compiled, including how it configures cross-compilation for other platforms.
* [georgewfraser/java-language-server](https://github.com/georgewfraser/java-language-server) ⭐ 814 | 🐛 117 | 🌐 Java | 📅 2026-09-19 - Java Language Server (LSP) with support for Bazel-built projects
* [rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) ⭐ 626 | 🐛 171 | 🌐 Swift | 📅 2026-09-24 - Generates Xcode projects for your workspace that builds with Bazel
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,444 | 🐛 450 | 🌐 Java | 📅 2026-09-24
* Emacs Support
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,193 | 🐛 123 | 🌐 Go | 📅 2026-09-23 contains:
...
* [wix-incubator/exodus](https://github.com/wix-incubator/exodus) ⭐ 230 | 🐛 17 | 🌐 Scala | 📅 2023-09-18 - Easily migrate your JVM code from Maven to Bazel
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 200,273 | 🐛 3,349 | 🌐 C++ | 📅 2026-09-24: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,094 | 🐛 12 | 🌐 Starlark | 📅 2026-09-23 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,139 | 🐛 239 | 🌐 C++ | 📅 2026-09-24 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 845 | 🐛 112 | 🌐 Swift | 📅 2026-09-23.
