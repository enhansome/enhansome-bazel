...
Have something to contribute or discuss? [Open a pull request](https://github.com/jin/awesome-bazel/pulls) ⭐ 1,240 | 🐛 13 | 📅 2024-11-13 or [create an issue](https://github.com/jin/awesome-bazel/issues) ⭐ 1,240 | 🐛 13 | 📅 2024-11-13.
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,298 | 🐛 1,317 | 🌐 TypeScript | 📅 2026-08-20 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 516 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-19 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,073 | 🐛 96 | 🌐 Python | 📅 2026-02-06
...
* [Bazel Common Libraries](https://github.com/google/bazel-common) ⭐ 90 | 🐛 19 | 🌐 Starlark | 📅 2026-08-18 - **Java-specific** Common functionality for Google's open-source libraries that are built with Bazel.
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,750 | 🐛 76 | 🌐 Go | 📅 2026-07-10 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 782 | 🐛 246 | 🌐 Go | 📅 2026-08-19 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 769 | 🐛 172 | 🌐 Java | 📅 2026-08-17 - Self-hosted remote caching and execution service written in Java
* [bazel-remote](https://github.com/buchgr/bazel-remote) ⭐ 765 | 🐛 81 | 🌐 Go | 📅 2026-07-29 - A simple remote cache for Bazel that supports HTTP and gRPC, with optional proxy backends for S3/GCS/HTTP.
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,412 | 🐛 458 | 🌐 Go | 📅 2026-08-19 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,412 | 🐛 458 | 🌐 Go | 📅 2026-08-19
...
* [georgewfraser/java-language-server](https://github.com/georgewfraser/java-language-server) ⭐ 811 | 🐛 116 | 🌐 Java | 📅 2026-08-11 - Java Language Server (LSP) with support for Bazel-built projects
* [rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) ⭐ 625 | 🐛 151 | 🌐 Swift | 📅 2026-08-18 - Generates Xcode projects for your workspace that builds with Bazel
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 294 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-19
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,187 | 🐛 122 | 🌐 Go | 📅 2026-08-19 contains:
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,070 | 🐛 3,093 | 🌐 C++ | 📅 2026-08-20: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,019 | 🐛 19 | 🌐 Starlark | 📅 2026-08-19 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,086 | 🐛 232 | 🌐 C++ | 📅 2026-08-20 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 847 | 🐛 103 | 🌐 Swift | 📅 2026-08-19.
