...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,586 | 🐛 1,435 | 🌐 TypeScript | 📅 2026-09-25 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 524 | 🐛 6 | 🌐 Rust | 📅 2026-09-24 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,094 | 🐛 98 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 80 | 🌐 Starlark | 📅 2026-09-24 - More common useful functions for writing custom build rules with Starlark
...
* [Starlet](https://github.com/1set/starlet) ⭐ 49 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,775 | 🐛 80 | 🌐 Go | 📅 2026-09-12 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 788 | 🐛 202 | 🌐 Go | 📅 2026-09-25 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,418 | 🐛 464 | 🌐 Go | 📅 2026-09-24 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,418 | 🐛 464 | 🌐 Go | 📅 2026-09-24
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 296 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-23
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 200,302 | 🐛 3,316 | 🌐 C++ | 📅 2026-09-25: Computation using data flow graphs for scalable machine learning.
...
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,140 | 🐛 242 | 🌐 C++ | 📅 2026-09-24 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 845 | 🐛 112 | 🌐 Swift | 📅 2026-09-25.
