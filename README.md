...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,075 | 🐛 96 | 🌐 Python | 📅 2026-02-06
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 785 | 🐛 231 | 🌐 Go | 📅 2026-08-27 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 771 | 🐛 173 | 🌐 Java | 📅 2026-08-26 - Self-hosted remote caching and execution service written in Java
* [bazel-remote](https://github.com/buchgr/bazel-remote) ⭐ 767 | 🐛 82 | 🌐 Go | 📅 2026-08-22 - A simple remote cache for Bazel that supports HTTP and gRPC, with optional proxy backends for S3/GCS/HTTP.
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,415 | 🐛 458 | 🌐 Go | 📅 2026-08-25 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,415 | 🐛 458 | 🌐 Go | 📅 2026-08-25
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 846 | 🐛 104 | 🌐 Swift | 📅 2026-08-27.
