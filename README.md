...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,407 | 🐛 1,328 | 🌐 TypeScript | 📅 2026-09-04 - Automate WORKSPACE dependencies updates
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 370 | 🐛 64 | 🌐 Starlark | 📅 2026-09-03 - LLVM toolchain for bazel
...
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,758 | 🐛 79 | 🌐 Go | 📅 2026-08-28 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 786 | 🐛 244 | 🌐 Go | 📅 2026-09-04 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazel-remote](https://github.com/buchgr/bazel-remote) ⭐ 772 | 🐛 86 | 🌐 Go | 📅 2026-08-22 - A simple remote cache for Bazel that supports HTTP and gRPC, with optional proxy backends for S3/GCS/HTTP.
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,415 | 🐛 459 | 🌐 Go | 📅 2026-09-03 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,415 | 🐛 459 | 🌐 Go | 📅 2026-09-03
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,430 | 🐛 446 | 🌐 Java | 📅 2026-09-04
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 294 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-03
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 198,796 | 🐛 3,076 | 🌐 C++ | 📅 2026-09-04: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,055 | 🐛 13 | 🌐 Starlark | 📅 2026-09-02 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,122 | 🐛 234 | 🌐 C++ | 📅 2026-09-03 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 845 | 🐛 105 | 🌐 Swift | 📅 2026-09-03.
