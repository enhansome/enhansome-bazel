...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,375 | 🐛 1,332 | 🌐 TypeScript | 📅 2026-08-30 - Automate WORKSPACE dependencies updates
* [bazel-diff](https://github.com/Tinder/bazel-diff) ⭐ 518 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-29 - Bazel Target Diffing between two revisions in Git, allowing for Test Target Selection and Selective Building
...
* [graknlabs/bazel-distribution](https://github.com/graknlabs/bazel-distribution) ⭐ 165 | 🐛 37 | 🌐 Starlark | 📅 2026-08-27 - Assemble and deploy software distributions to common platforms, e.g. APT, Brew, GitHub, Maven, NPM, PIP, RPM, etc.
...
* [gerrit/bazlets](https://github.com/GerritCodeReview/bazlets) ⭐ 14 | 🐛 1 | 🌐 Starlark | 📅 2026-08-30 - Gerrit's re-usable building blocks for Bazel build tool
...
* [grailbio/bazel-toolchain](https://github.com/grailbio/bazel-toolchain) ⭐ 370 | 🐛 64 | 🌐 Starlark | 📅 2026-08-29 - LLVM toolchain for bazel
...
* [f0rmiga/gcc-toolchain](https://github.com/f0rmiga/gcc-toolchain) ⭐ 137 | 🐛 18 | 🌐 Starlark | 📅 2026-08-11 - A fully-hermetic Bazel GCC toolchain for Linux
...
* [Language description](https://github.com/bazelbuild/starlark/) ⭐ 3,076 | 🐛 97 | 🌐 Python | 📅 2026-02-06
...
* [aspect\_bazel\_lib](https://github.com/aspect-build/bazel-lib) ⭐ 182 | 🐛 77 | 🌐 Starlark | 📅 2026-08-28 - More common useful functions for writing custom build rules with Starlark
...
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - Go wrapper for [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,756 | 🐛 77 | 🌐 Go | 📅 2026-08-28 that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
* [buildbuddy-io/buildbuddy](https://github.com/buildbuddy-io/buildbuddy) ⭐ 785 | 🐛 233 | 🌐 Go | 📅 2026-08-29 - Cloud or self-hosted remote caching and execution service written in Go, with Web UI for viewing and debugging build logs
* [bazelbuild/bazel-buildfarm](https://github.com/bazelbuild/bazel-buildfarm) ⭐ 771 | 🐛 176 | 🌐 Java | 📅 2026-08-26 - Self-hosted remote caching and execution service written in Java
* [bazel-remote](https://github.com/buchgr/bazel-remote) ⭐ 768 | 🐛 82 | 🌐 Go | 📅 2026-08-22 - A simple remote cache for Bazel that supports HTTP and gRPC, with optional proxy backends for S3/GCS/HTTP.
...
* [Gazelle](https://github.com/bazelbuild/bazel-gazelle) ⭐ 1,415 | 🐛 461 | 🌐 Go | 📅 2026-08-29 - BUILD file generator with extensions for many languages. See the list of available plugins in the project README: <https://github.com/bazelbuild/bazel-gazelle#supported-languages> ⭐ 1,415 | 🐛 461 | 🌐 Go | 📅 2026-08-29
...
* [hedronvision/bazel-compile-commands-extractor](https://github.com/hedronvision/bazel-compile-commands-extractor) ⭐ 916 | 🐛 100 | 🌐 Python | 📅 2025-08-11 enables autocomplete, smart navigation, quick fixes, and more in a wide variety of extensible editors, including VSCode, Vim, Emacs, Atom, and Sublime. It lets language servers, like clangd, ccls, and other types of tooling, draw upon Bazel’s understanding of how `cc` and `objc` code will be compiled, including how it configures cross-compilation for other platforms.
* [georgewfraser/java-language-server](https://github.com/georgewfraser/java-language-server) ⭐ 813 | 🐛 117 | 🌐 Java | 📅 2026-08-20 - Java Language Server (LSP) with support for Bazel-built projects
* [rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) ⭐ 625 | 🐛 150 | 🌐 Swift | 📅 2026-08-27 - Generates Xcode projects for your workspace that builds with Bazel
...
* Eclipse Support
  ...
  * [B2Eclipse](https://github.com/salesforce/bazel-ls-eclipse) ⚠️ Archived - Bazel Eclipse plugin based on [Eclipse JDT LS](https://github.com/eclipse/eclipse.jdt.ls) ⭐ 2,427 | 🐛 446 | 🌐 Java | 📅 2026-08-28
* Emacs Support
...
* VSCode Support
  * [bazelbuild/vscode-bazel](https://github.com/bazelbuild/vscode-bazel) ⭐ 294 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-30
...
[bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) ⭐ 1,190 | 🐛 121 | 🌐 Go | 📅 2026-08-26 contains:
...
* [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 198,028 | 🐛 2,983 | 🌐 C++ | 📅 2026-08-30: Computation using data flow graphs for scalable machine learning.
* [GoogleCloudPlatform/distroless](https://github.com/GoogleCloudPlatform/distroless) ⭐ 23,045 | 🐛 14 | 🌐 Starlark | 📅 2026-08-28 - Language focused docker images, minus the operating system.
* [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 18,107 | 🐛 235 | 🌐 C++ | 📅 2026-08-29 - OSS collection of C++ code (compliant to C++11) designed to augment the C++ standard library.
...
* [kastiglione/bazel-xcode-demo-swift-driver](https://github.com/kastiglione/bazel-xcode-demo-swift-driver) ⭐ 56 | 🐛 0 | 🌐 Swift | 📅 2020-01-30: Demonstrates using Bazel and Xcode, to build [apple/swift-driver](https://github.com/apple/swift-driver) ⭐ 846 | 🐛 106 | 🌐 Swift | 📅 2026-08-30.
